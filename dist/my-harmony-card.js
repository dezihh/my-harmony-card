 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,x=w.trustedTypes,k=x?x.createPolicy("lit-html",{createHTML:t=>t}):void 0,A="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,E="?"+C,S=`<${E}>`,O=document,B=()=>O.createComment(""),P=t=>null===t||"object"!=typeof t&&"function"!=typeof t,U=Array.isArray,T="[ \t\n\f\r]",D=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,R=/-->/g,N=/>/g,H=RegExp(`>|${T}(?:([^\\s"'>=/]+)(${T}*=${T}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),M=/'/g,j=/"/g,I=/^(?:script|style|textarea|title)$/i,z=(t=>(i,...e)=>({_$litType$:t,strings:i,values:e}))(1),L=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),V=new WeakMap,W=O.createTreeWalker(O,129);function K(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==k?k.createHTML(i):i}const q=(t,i)=>{const e=t.length-1,o=[];let n,s=2===i?"<svg>":"",r=D;for(let i=0;i<e;i++){const e=t[i];let a,c,l=-1,h=0;for(;h<e.length&&(r.lastIndex=h,c=r.exec(e),null!==c);)h=r.lastIndex,r===D?"!--"===c[1]?r=R:void 0!==c[1]?r=N:void 0!==c[2]?(I.test(c[2])&&(n=RegExp("</"+c[2],"g")),r=H):void 0!==c[3]&&(r=H):r===H?">"===c[0]?(r=n??D,l=-1):void 0===c[1]?l=-2:(l=r.lastIndex-c[2].length,a=c[1],r=void 0===c[3]?H:'"'===c[3]?j:M):r===j||r===M?r=H:r===R||r===N?r=D:(r=H,n=void 0);const d=r===H&&t[i+1].startsWith("/>")?" ":"";s+=r===D?e+S:l>=0?(o.push(a),e.slice(0,l)+A+e.slice(l)+C+d):e+C+(-2===l?i:d)}return[K(t,s+(t[e]||"<?>")+(2===i?"</svg>":"")),o]};class G{constructor({strings:t,_$litType$:i},e){let o;this.parts=[];let n=0,s=0;const r=t.length-1,a=this.parts,[c,l]=q(t,i);if(this.el=G.createElement(c,e),W.currentNode=this.el.content,2===i){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(o=W.nextNode())&&a.length<r;){if(1===o.nodeType){if(o.hasAttributes())for(const t of o.getAttributeNames())if(t.endsWith(A)){const i=l[s++],e=o.getAttribute(t).split(C),r=/([.?@])?(.*)/.exec(i);a.push({type:1,index:n,name:r[2],strings:e,ctor:"."===r[1]?Q:"?"===r[1]?tt:"@"===r[1]?it:X}),o.removeAttribute(t)}else t.startsWith(C)&&(a.push({type:6,index:n}),o.removeAttribute(t));if(I.test(o.tagName)){const t=o.textContent.split(C),i=t.length-1;if(i>0){o.textContent=x?x.emptyScript:"";for(let e=0;e<i;e++)o.append(t[e],B()),W.nextNode(),a.push({type:2,index:++n});o.append(t[i],B())}}}else if(8===o.nodeType)if(o.data===E)a.push({type:2,index:n});else{let t=-1;for(;-1!==(t=o.data.indexOf(C,t+1));)a.push({type:7,index:n}),t+=C.length-1}n++}}static createElement(t,i){const e=O.createElement("template");return e.innerHTML=t,e}}function Y(t,i,e=t,o){if(i===L)return i;let n=void 0!==o?e._$Co?.[o]:e._$Cl;const s=P(i)?void 0:i._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),void 0===s?n=void 0:(n=new s(t),n._$AT(t,e,o)),void 0!==o?(e._$Co??=[])[o]=n:e._$Cl=n),void 0!==n&&(i=Y(t,n._$AS(t,i.values),n,o)),i}class J{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:e}=this._$AD,o=(t?.creationScope??O).importNode(i,!0);W.currentNode=o;let n=W.nextNode(),s=0,r=0,a=e[0];for(;void 0!==a;){if(s===a.index){let i;2===a.type?i=new Z(n,n.nextSibling,this,t):1===a.type?i=new a.ctor(n,a.name,a.strings,this,t):6===a.type&&(i=new et(n,this,t)),this._$AV.push(i),a=e[++r]}s!==a?.index&&(n=W.nextNode(),s++)}return W.currentNode=O,o}p(t){let i=0;for(const e of this._$AV)void 0!==e&&(void 0!==e.strings?(e._$AI(t,e,i),i+=e.strings.length-2):e._$AI(t[i])),i++}}class Z{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,i,e,o){this.type=2,this._$AH=F,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=e,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t?.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=Y(this,t,i),P(t)?t===F||null==t||""===t?(this._$AH!==F&&this._$AR(),this._$AH=F):t!==this._$AH&&t!==L&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>U(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}S(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.S(t))}_(t){this._$AH!==F&&P(this._$AH)?this._$AA.nextSibling.data=t:this.T(O.createTextNode(t)),this._$AH=t}$(t){const{values:i,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=G.createElement(K(e.h,e.h[0]),this.options)),e);if(this._$AH?._$AD===o)this._$AH.p(i);else{const t=new J(o,this),e=t.u(this.options);t.p(i),this.T(e),this._$AH=t}}_$AC(t){let i=V.get(t.strings);return void 0===i&&V.set(t.strings,i=new G(t)),i}k(t){U(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let e,o=0;for(const n of t)o===i.length?i.push(e=new Z(this.S(B()),this.S(B()),this,this.options)):e=i[o],e._$AI(n),o++;o<i.length&&(this._$AR(e&&e._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class X{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,e,o,n){this.type=1,this._$AH=F,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=n,e.length>2||""!==e[0]||""!==e[1]?(this._$AH=Array(e.length-1).fill(new String),this.strings=e):this._$AH=F}_$AI(t,i=this,e,o){const n=this.strings;let s=!1;if(void 0===n)t=Y(this,t,i,0),s=!P(t)||t!==this._$AH&&t!==L,s&&(this._$AH=t);else{const o=t;let r,a;for(t=n[0],r=0;r<n.length-1;r++)a=Y(this,o[e+r],i,r),a===L&&(a=this._$AH[r]),s||=!P(a)||a!==this._$AH[r],a===F?t=F:t!==F&&(t+=(a??"")+n[r+1]),this._$AH[r]=a}s&&!o&&this.j(t)}j(t){t===F?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Q extends X{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===F?void 0:t}}class tt extends X{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==F)}}class it extends X{constructor(t,i,e,o,n){super(t,i,e,o,n),this.type=5}_$AI(t,i=this){if((t=Y(this,t,i,0)??F)===L)return;const e=this._$AH,o=t===F&&e!==F||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==F&&(e===F||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class et{constructor(t,i,e){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=e}get _$AU(){return this._$AM._$AU}_$AI(t){Y(this,t)}}const ot=w.litHtmlPolyfillSupport;ot?.(G,Z),(w.litHtmlVersions??=[]).push("3.1.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
class nt extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,i,e)=>{const o=e?.renderBefore??i;let n=o._$litPart$;if(void 0===n){const t=e?.renderBefore??null;o._$litPart$=n=new Z(i.insertBefore(B(),t),t,void 0,e??{})}return n._$AI(t),n})(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return L}}nt._$litElement$=!0,nt.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:nt});const st=globalThis.litElementPolyfillSupport;st?.({LitElement:nt}),(globalThis.litElementVersions??=[]).push("4.0.6");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const rt=t=>(i,e)=>{void 0!==e?e.addInitializer((()=>{customElements.define(t,i)})):customElements.define(t,i)};var at,ct;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(at||(at={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ct||(ct={}));const lt="my-harmony-card",ht="my-harmony-card-editor",dt=((t,...i)=>{const e=1===t.length?t[0]:i.reduce(((i,e,o)=>i+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(e)+t[o+1]),t[0]);return new s(e,t,o)})`
  @keyframes blinker {
    50% {
      opacity: 0;
    }
  ...
  .popup-dialog img:hover {
    ...
    `:z``}static get styles(){return dt}};ut=t([rt(ht)],ut);console.info("%c  My Harmony Remote Control Card  \n%c  version: v@MY_HARMOY_CARD_VERSION_PLACEHOLDER@  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");const pt=window;pt.customCards=pt.customCards||[],pt.customCards.push({type:lt,name:"My Harmony Remote Control Card",preview:!0,description:"Remote control card for Harmony Companion Remote Controllers"});let gt=class extends nt{static get styles(){return dt}static getConfigElement(){return document.createElement(ht)}static getStubConfig(t){let i=Object.keys(t.entities).filter((t=>t.startsWith("remote.")));const e=i.length>0?i[0]:"";return{type:`custom:${lt}`,entity:e}}_getFavorites(){var t;const i=null===(t=this.config.activities)||void 0===t?void 0:t[this._current_activity];return((null==i?void 0:i.favorites)||[]).map((t=>({number:t.number,image:t.image})))}_handle123ButtonDown(){this.buttonTimeout=setTimeout((()=>{this._getFavorites().length>0&&this._popcard()}),500)}_handle123ButtonUp(){clearTimeout(this.buttonTimeout),this._show_keypad=!this._show_keypad}_handleButtonDown(t,i){this.isButtonPressed=!0,this.buttonTimeout=setTimeout((()=>{this.isButtonPressed&&("media"===i?this._moreMediaPlayer():this._button(i),this.isButtonPressed=!1)}),500)}_handleButtonUp(t){this.isButtonPressed&&this._button(t),this.buttonTimeout&&(clearTimeout(this.buttonTimeout),this.buttonTimeout=null),this.isButtonPressed=!1}static get properties(){return{hass:{},config:{},_show_keypad:{},_show_activity:{},_show_vol_text:{},_current_activity:{type:String}}}constructor(){super(),this.isButtonPressed=!1,this.buttonTimeout=null,this._show_keypad=!1,this._show_activity=!1,this._current_activity="",this.debug=!1,this._dialogOpen=!1}_toggleDialog(){this._dialogOpen=!this._dialogOpen,this.requestUpdate()}_popcard(){this._dialogOpen=!0,this.requestUpdate()}_moreMediaPlayer(){const t=this.config.activities[this._current_activity].player_name;t&&function(t,i,e,o){o=o||{},e=null==e?{}:e;var n=new Event(i,{bubbles:void 0===o.bubbles||o.bubbles,cancelable:Boolean(o.cancelable),composed:void 0===o.composed||o.composed});n.detail=e,t.dispatchEvent(n)}(this,"hass-more-info",{entityId:t}),this.debug&&console.log("More Info media_player called",t)}_renderTable(){const t=this._getFavorites(),i=this.config.favsize?this.config.favsize:50;return z`
        <!-- <tbody>  -->
          <!-- <div class="popup-container"> -->
            ${t.map((t=>z`
                  <img style="max-height: ${i}px;" src='${t.image}' alt="${t.number}" @click=${()=>this._chanchange(t.number)} />
              <!-- </div>   -->         
            `))}
       <!-- </tbody>-->
        ...
        <div class="card">
            <div class="page"
                ...
                <div class="grid-container-power" style="--remotewidth: ${r}">
                    ...
                    <button class="btn-flat flat-high ripple btn-text"
                      @mousedown=${t=>this._handle123ButtonDown()}
                      @mouseup=${t=>this._handle123ButtonUp()}
