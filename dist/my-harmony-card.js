 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,x=w.trustedTypes,k=x?x.createPolicy("lit-html",{createHTML:t=>t}):void 0,A="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,C="?"+E,S=`<${C}>`,O=document,P=()=>O.createComment(""),T=t=>null===t||"object"!=typeof t&&"function"!=typeof t,B=Array.isArray,U="[ \t\n\f\r]",D=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,H=/-->/g,R=/>/g,N=RegExp(`>|${U}(?:([^\\s"'>=/]+)(${U}*=${U}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),M=/'/g,j=/"/g,z=/^(?:script|style|textarea|title)$/i,I=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),L=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),K=new WeakMap,V=O.createTreeWalker(O,129);function W(t,e){if(!B(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==k?k.createHTML(e):e}class q{constructor({strings:t,_$litType$:e},i){let o;this.parts=[];let n=0,s=0;const r=t.length-1,a=this.parts,[c,l]=((t,e)=>{const i=t.length-1,o=[];let n,s=2===e?"<svg>":3===e?"<math>":"",r=D;for(let e=0;e<i;e++){const i=t[e];let a,c,l=-1,d=0;for(;d<i.length&&(r.lastIndex=d,c=r.exec(i),null!==c);)d=r.lastIndex,r===D?"!--"===c[1]?r=H:void 0!==c[1]?r=R:void 0!==c[2]?(z.test(c[2])&&(n=RegExp("</"+c[2],"g")),r=N):void 0!==c[3]&&(r=N):r===N?">"===c[0]?(r=n??D,l=-1):void 0===c[1]?l=-2:(l=r.lastIndex-c[2].length,a=c[1],r=void 0===c[3]?N:'"'===c[3]?j:M):r===j||r===M?r=N:r===H||r===R?r=D:(r=N,n=void 0);const h=r===N&&t[e+1].startsWith("/>")?" ":"";s+=r===D?i+S:l>=0?(o.push(a),i.slice(0,l)+A+i.slice(l)+E+h):i+E+(-2===l?e:h)}return[W(t,s+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),o]})(t,e);if(this.el=q.createElement(c,i),V.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(o=V.nextNode())&&a.length<r;){if(1===o.nodeType){if(o.hasAttributes())for(const t of o.getAttributeNames())if(t.endsWith(A)){const e=l[s++],i=o.getAttribute(t).split(E),r=/([.?@])?(.*)/.exec(e);a.push({type:1,index:n,name:r[2],strings:i,ctor:"."===r[1]?X:"?"===r[1]?Q:"@"===r[1]?tt:Z}),o.removeAttribute(t)}else t.startsWith(E)&&(a.push({type:6,index:n}),o.removeAttribute(t));if(z.test(o.tagName)){const t=o.textContent.split(E),e=t.length-1;if(e>0){o.textContent=x?x.emptyScript:"";for(let i=0;i<e;i++)o.append(t[i],P()),V.nextNode(),a.push({type:2,index:++n});o.append(t[e],P())}}}else if(8===o.nodeType)if(o.data===C)a.push({type:2,index:n});else{let t=-1;for(;-1!==(t=o.data.indexOf(E,t+1));)a.push({type:7,index:n}),t+=E.length-1}n++}}static createElement(t,e){const i=O.createElement("template");return i.innerHTML=t,i}}function G(t,e,i=t,o){if(e===L)return e;let n=void 0!==o?i.o?.[o]:i.l;const s=T(e)?void 0:e._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),void 0===s?n=void 0:(n=new s(t),n._$AT(t,i,o)),void 0!==o?(i.o??=[])[o]=n:i.l=n),void 0!==n&&(e=G(t,n._$AS(t,e.values),n,o)),e}class J{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,o=(t?.creationScope??O).importNode(e,!0);V.currentNode=o;let n=V.nextNode(),s=0,r=0,a=i[0];for(;void 0!==a;){if(s===a.index){let e;2===a.type?e=new Y(n,n.nextSibling,this,t):1===a.type?e=new a.ctor(n,a.name,a.strings,this,t):6===a.type&&(e=new et(n,this,t)),this._$AV.push(e),a=i[++r]}s!==a?.index&&(n=V.nextNode(),s++)}return V.currentNode=O,o}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class Y{get _$AU(){return this._$AM?._$AU??this.v}constructor(t,e,i,o){this.type=2,this._$AH=F,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=o,this.v=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=G(this,t,e),T(t)?t===F||null==t||""===t?(this._$AH!==F&&this._$AR(),this._$AH=F):t!==this._$AH&&t!==L&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>B(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==F&&T(this._$AH)?this._$AA.nextSibling.data=t:this.T(O.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,o="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=q.createElement(W(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===o)this._$AH.p(e);else{const t=new J(o,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=K.get(t.strings);return void 0===e&&K.set(t.strings,e=new q(t)),e}k(t){B(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,o=0;for(const n of t)o===e.length?e.push(i=new Y(this.O(P()),this.O(P()),this,this.options)):i=e[o],i._$AI(n),o++;o<e.length&&(this._$AR(i&&i._$AB.nextSibling,o),e.length=o)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){void 0===this._$AM&&(this.v=t,this._$AP?.(t))}}class Z{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,o,n){this.type=1,this._$AH=F,this._$AN=void 0,this.element=t,this.name=e,this._$AM=o,this.options=n,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=F}_$AI(t,e=this,i,o){const n=this.strings;let s=!1;if(void 0===n)t=G(this,t,e,0),s=!T(t)||t!==this._$AH&&t!==L,s&&(this._$AH=t);else{const o=t;let r,a;for(t=n[0],r=0;r<n.length-1;r++)a=G(this,o[i+r],e,r),a===L&&(a=this._$AH[r]),s||=!T(a)||a!==this._$AH[r],a===F?t=F:t!==F&&(t+=(a??"")+n[r+1]),this._$AH[r]=a}s&&!o&&this.j(t)}j(t){t===F?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class X extends Z{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===F?void 0:t}}class Q extends Z{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==F)}}class tt extends Z{constructor(t,e,i,o,n){super(t,e,i,o,n),this.type=5}_$AI(t,e=this){if((t=G(this,t,e,0)??F)===L)return;const i=this._$AH,o=t===F&&i!==F||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==F&&(i===F||o);o&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class et{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){G(this,t)}}const it=w.litHtmlPolyfillSupport;it?.(q,Y),(w.litHtmlVersions??=[]).push("3.2.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
  ...
  .popup-dialog img:hover {
    transform: scale(1.1); 
      ...
      <select name="entity" id="entity" class="select-item" .value="${t}"
        ...
        ${i}
        ${e.map((t=>t!=this._config.entity?I`<option value="${t}">${this.hass.states[t].attributes.friendly_name||t}</option>`:I`<option value="${t}" selected>${this.hass.states[t].attributes.friendly_name||t}</option>`))}
      </select>
      <br><br>
    ...
    `}setDimensions(t){const e=Object.assign(Object.assign({},{scale:1,border_width:1}),t||{}),i=parseFloat(e.border_width);return I`
      ...
      <br>
      <label for="scale" style="margin-top:0px;">Card Scale: ${e.scale}</label><br>
      <input type="range" min="0.5" max="1.5" step="0.01" .value="${e.scale}" id="scale" name="scale" @input=${this.dimensionsConfigChanged} style="width: 40ch;">
      <br><br>
    ...
    `}handleImportActivitiesCheckboxChange(t){const e=t.target;t.target.checked&&this.syncActivities(),setTimeout((()=>{e.checked=!1}),200)}checkActivities(){const t=this._config.activities||{};if("object"!=typeof t||null===t)return I`
      ...
      `;const e=Object.keys(t);return e.length>0?I`
        ...
        <div class="outer-container">
          ${e.map(((e,i)=>{let o=Object.assign({},t[e]);if(!o.device_id){o.device_id="-1";const t=Object.assign(Object.assign({},this._config.activities),{[e]:o});this._config=Object.assign(Object.assign({},this._config),{activities:t}),this.requestUpdate()}return I`
              <div class="activity-container">
                <div class="form-group">
                  <label for="activity-${i}-key" class="activity-identifier">${e}:</label>
                  <input type="text" id="activity-${i}-device-id" .value="${o.device_id}"
      ...
      `}render(){var t;const e=this.hass.states[this.config.entity];this.config.color_buttons,this._current_activity=e.attributes.current_activity;const i=null===(t=this.config.activities)||void 0===t?void 0:t[this._current_activity];i?(this.defaultDeviceId=i.device_id||null,this.volumeDeviceId=i.volume_device_id||this.defaultDeviceId):(this.defaultDeviceId=-1,this.volumeDeviceId=-1,this._current_activity="PowerOff");const o="PowerOff"===this._current_activity?"red":"green";this.debug&&console.log(`Current Activity ${e.attributes.current_activity} - DeviceID: ${i.device_id} `);const n=this.config.dimensions&&this.config.dimensions.border_width?this.config.dimensions.border_width:"1px",s=this.config.dimensions&&this.config.dimensions.scale?this.config.dimensions.scale:1,r=Math.round(260*s)+"px",a=this.config.colors&&this.config.colors.background?this.config.colors.background:"var( --ha-card-background, var(--card-background-color, white) )",c=this.config.colors&&this.config.colors.border?this.config.colors.border:"var(--primary-text-color)",l=this.config.colors&&this.config.colors.buttons?this.config.colors.buttons:"var(--secondary-background-color)",d=this.config.colors&&this.config.colors.text?this.config.colors.text:"var(--primary-text-color)";return I`
        ...
        <div class="card">
            <div class="page"
                ...
                <!-- Power row -->
                ${this.config.name?I` <div class="tv_title" style="color:${d}" >${this.config.name}</div> `:""}
                    
                    <button class="act_action button-style" style="color:${d}"
                ...
                ${this._show_activity?I`
                    ...
                    <div class="grid-container-act">
                        ...
                        <p class="act_text" style="color:${d}"><b>ACTIONS</b></p>
                        <div class="grid-item-act">
                           ${e.attributes.activity_list.map((t=>I`
                                <button class="button-style ${e.attributes.current_activity===t?"btn-act-on":"btn-act ripple overlay"}" @click=${()=>{this._select_activity(t),this._show_activity=!1}}>${t}</button>
                            `))}
                        </div>
                    </div>
                      ...
                      <div class="shape">
                       ...
                       <div class="grid-container-extra">
                          ${(()=>{var t;const e=null===(t=this.config.activities)||void 0===t?void 0:t[this._current_activity],i=null==e?void 0:e.Button1;return i?I`
                              <button class="ripple btn-extra button-style"
                                @click=${()=>{i.service?this._service(i.service,i.data):i.command&&this._button(i.command)}}
                                title=${i.tooltip||""}>
                                ${i.icon?I`<ha-icon class="mdi-extra button-style" icon="${i.icon}"></ha-icon>`:i.name}
                              </button>
                            `:I``})()}
                       ...
                       <div class="grid-container-extra_2">
                          ...
                          ${(()=>{const t=this.config.ButtonA;return t?I`
                              <button class="ripple btn-extra button-style"
                                @click=${()=>{t.service?this._service(t.service,t.data):t.command&&this._button(t.command)}}
                                title=${t.tooltip||""}>
                                ${t.icon?I`<ha-icon class="mdi-extra button-style" icon="${t.icon}"></ha-icon>`:t.name}
                              </button>`:""})()}

                          ${(()=>{const t=this.config.ButtonB;return t?I`
                              <button class="ripple btn-extra button-style"
                                @click=${()=>{t.service?this._service(t.service,t.data):t.command&&this._button(t.command)}}
                                title=${t.tooltip||""}>
                                ${t.icon?I`<ha-icon class="mdi-extra button-style" icon="${t.icon}"></ha-icon>`:t.name}
                          ...
                          ${(()=>{const t=this.config.ButtonC;return t?I`
                              <button class="ripple btn-extra button-style"
                                @click=${()=>{t.service?this._service(t.service,t.data):t.command&&this._button(t.command)}}
                                title=${t.tooltip||""}>
                                ${t.icon?I`<ha-icon class="mdi-extra button-style" icon="${t.icon}"></ha-icon>`:t.name}
                           ...
                           ${(()=>{const t=this.config.ButtonD;return t?I`
                              <button class="ripple btn-extra button-style"
                                @click=${()=>{t.service?this._service(t.service,t.data):t.command&&this._button(t.command)}}
                                title=${t.tooltip||""}>
                                ${t.icon?I`<ha-icon class="mdi-extra button-style" icon="${t.icon}"></ha-icon>`:t.name}
