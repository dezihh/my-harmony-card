 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */,{is:c,defineProperty:a,getOwnPropertyDescriptor:l,getOwnPropertyNames:h,getOwnPropertySymbols:d,getPrototypeOf:u}=Object,p=globalThis,g=p.trustedTypes,b=g?g.emptyScript:"",m=p.reactiveElementPolyfillSupport,v=(t,i)=>t,f={toAttribute(t,i){switch(i){case Boolean:t=t?b:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,i){let e=t;switch(i){case Boolean:e=null!==t;break;case Number:e=null===t?null:Number(t);break;case Object:case Array:try{e=JSON.parse(t)}catch(t){e=null}}return e}},_=(t,i)=>!c(t,i),y={attribute:!0,type:String,converter:f,reflect:!1,hasChanged:_};Symbol.metadata??=Symbol("metadata"),p.litPropertyMetadata??=new WeakMap;class $ extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,i=y){if(i.state&&(i.attribute=!1),this._$Ei(),this.elementProperties.set(t,i),!i.noAccessor){const e=Symbol(),o=this.getPropertyDescriptor(t,e,i);void 0!==o&&a(this.prototype,t,o)}}static getPropertyDescriptor(t,i,e){const{get:o,set:n}=l(this.prototype,t)??{get(){return this[i]},set(t){this[i]=t}};return{get(){return o?.call(this)},set(i){const s=o?.call(this);n.call(this,i),this.requestUpdate(t,s,e)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??y}static _$Ei(){if(this.hasOwnProperty(v("elementProperties")))return;const t=u(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(v("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(v("properties"))){const t=this.properties,i=[...h(t),...d(t)];for(const e of i)this.createProperty(e,t[e])}const t=this[Symbol.metadata];if(null!==t){const i=litPropertyMetadata.get(t);if(void 0!==i)for(const[t,e]of i)this.elementProperties.set(t,e)}this._$Eh=new Map;for(const[t,i]of this.elementProperties){const e=this._$Eu(t,i);void 0!==e&&this._$Eh.set(e,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const i=[];if(Array.isArray(t)){const e=new Set(t.flat(1/0).reverse());for(const t of e)i.unshift(r(t))}else void 0!==t&&i.push(r(t));return i}static _$Eu(t,i){const e=i.attribute;return!1===e?void 0:"string"==typeof e?e:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((t=>t(this)))}addController(t){(this._$EO??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,i=this.constructor.elementProperties;for(const e of i.keys())this.hasOwnProperty(e)&&(t.set(e,this[e]),delete this[e]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((t,o)=>{if(e)t.adoptedStyleSheets=o.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet));else for(const e of o){const o=document.createElement("style"),n=i.litNonce;void 0!==n&&o.setAttribute("nonce",n),o.textContent=e.cssText,t.appendChild(o)}})(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((t=>t.hostConnected?.()))}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach((t=>t.hostDisconnected?.()))}attributeChangedCallback(t,i,e){this._$AK(t,e)}_$EC(t,i){const e=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,e);if(void 0!==o&&!0===e.reflect){const n=(void 0!==e.converter?.toAttribute?e.converter:f).toAttribute(i,e.type);this._$Em=t,null==n?this.removeAttribute(o):this.setAttribute(o,n),this._$Em=null}}_$AK(t,i){const e=this.constructor,o=e._$Eh.get(t);if(void 0!==o&&this._$Em!==o){const t=e.getPropertyOptions(o),n="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:f;this._$Em=o,this[o]=n.fromAttribute(i,t.type),this._$Em=null}}requestUpdate(t,i,e){if(void 0!==t){if(e??=this.constructor.getPropertyOptions(t),!(e.hasChanged??_)(this[t],i))return;this.P(t,i,e)}!1===this.isUpdatePending&&(this._$ES=this._$ET())}P(t,i,e){this._$AL.has(t)||this._$AL.set(t,i),!0===e.reflect&&this._$Em!==t&&(this._$Ej??=new Set).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[t,i]of this._$Ep)this[t]=i;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[i,e]of t)!0!==e.wrapped||this._$AL.has(i)||void 0===this[i]||this.P(i,this[i],e)}let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),this._$EO?.forEach((t=>t.hostUpdate?.())),this.update(i)):this._$EU()}catch(i){throw t=!1,this._$EU(),i}t&&this._$AE(i)}willUpdate(t){}_$AE(t){this._$EO?.forEach((t=>t.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&=this._$Ej.forEach((t=>this._$EC(t,this[t]))),this._$EU()}updated(t){}firstUpdated(t){}}$.elementStyles=[],$.shadowRootOptions={mode:"open"},$[v("elementProperties")]=new Map,$[v("finalized")]=new Map,m?.({ReactiveElement:$}),(p.reactiveElementVersions??=[]).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,x=w.trustedTypes,k=x?x.createPolicy("lit-html",{createHTML:t=>t}):void 0,A="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,C="?"+E,B=`<${C}>`,S=document,O=()=>S.createComment(""),P=t=>null===t||"object"!=typeof t&&"function"!=typeof t,T=Array.isArray,U="[ \t\n\f\r]",D=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,H=/-->/g,R=/>/g,N=RegExp(`>|${U}(?:([^\\s"'>=/]+)(${U}*=${U}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),M=/'/g,j=/"/g,z=/^(?:script|style|textarea|title)$/i,I=(t=>(i,...e)=>({_$litType$:t,strings:i,values:e}))(1),L=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),K=new WeakMap,V=S.createTreeWalker(S,129);function W(t,i){if(!T(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==k?k.createHTML(i):i}class q{constructor({strings:t,_$litType$:i},e){let o;this.parts=[];let n=0,s=0;const r=t.length-1,c=this.parts,[a,l]=((t,i)=>{const e=t.length-1,o=[];let n,s=2===i?"<svg>":3===i?"<math>":"",r=D;for(let i=0;i<e;i++){const e=t[i];let c,a,l=-1,h=0;for(;h<e.length&&(r.lastIndex=h,a=r.exec(e),null!==a);)h=r.lastIndex,r===D?"!--"===a[1]?r=H:void 0!==a[1]?r=R:void 0!==a[2]?(z.test(a[2])&&(n=RegExp("</"+a[2],"g")),r=N):void 0!==a[3]&&(r=N):r===N?">"===a[0]?(r=n??D,l=-1):void 0===a[1]?l=-2:(l=r.lastIndex-a[2].length,c=a[1],r=void 0===a[3]?N:'"'===a[3]?j:M):r===j||r===M?r=N:r===H||r===R?r=D:(r=N,n=void 0);const d=r===N&&t[i+1].startsWith("/>")?" ":"";s+=r===D?e+B:l>=0?(o.push(c),e.slice(0,l)+A+e.slice(l)+E+d):e+E+(-2===l?i:d)}return[W(t,s+(t[e]||"<?>")+(2===i?"</svg>":3===i?"</math>":"")),o]})(t,i);if(this.el=q.createElement(a,e),V.currentNode=this.el.content,2===i||3===i){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(o=V.nextNode())&&c.length<r;){if(1===o.nodeType){if(o.hasAttributes())for(const t of o.getAttributeNames())if(t.endsWith(A)){const i=l[s++],e=o.getAttribute(t).split(E),r=/([.?@])?(.*)/.exec(i);c.push({type:1,index:n,name:r[2],strings:e,ctor:"."===r[1]?X:"?"===r[1]?Q:"@"===r[1]?tt:J}),o.removeAttribute(t)}else t.startsWith(E)&&(c.push({type:6,index:n}),o.removeAttribute(t));if(z.test(o.tagName)){const t=o.textContent.split(E),i=t.length-1;if(i>0){o.textContent=x?x.emptyScript:"";for(let e=0;e<i;e++)o.append(t[e],O()),V.nextNode(),c.push({type:2,index:++n});o.append(t[i],O())}}}else if(8===o.nodeType)if(o.data===C)c.push({type:2,index:n});else{let t=-1;for(;-1!==(t=o.data.indexOf(E,t+1));)c.push({type:7,index:n}),t+=E.length-1}n++}}static createElement(t,i){const e=S.createElement("template");return e.innerHTML=t,e}}function G(t,i,e=t,o){if(i===L)return i;let n=void 0!==o?e.o?.[o]:e.l;const s=P(i)?void 0:i._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),void 0===s?n=void 0:(n=new s(t),n._$AT(t,e,o)),void 0!==o?(e.o??=[])[o]=n:e.l=n),void 0!==n&&(i=G(t,n._$AS(t,i.values),n,o)),i}class Y{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:e}=this._$AD,o=(t?.creationScope??S).importNode(i,!0);V.currentNode=o;let n=V.nextNode(),s=0,r=0,c=e[0];for(;void 0!==c;){if(s===c.index){let i;2===c.type?i=new Z(n,n.nextSibling,this,t):1===c.type?i=new c.ctor(n,c.name,c.strings,this,t):6===c.type&&(i=new it(n,this,t)),this._$AV.push(i),c=e[++r]}s!==c?.index&&(n=V.nextNode(),s++)}return V.currentNode=S,o}p(t){let i=0;for(const e of this._$AV)void 0!==e&&(void 0!==e.strings?(e._$AI(t,e,i),i+=e.strings.length-2):e._$AI(t[i])),i++}}class Z{get _$AU(){return this._$AM?._$AU??this.v}constructor(t,i,e,o){this.type=2,this._$AH=F,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=e,this.options=o,this.v=o?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t?.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=G(this,t,i),P(t)?t===F||null==t||""===t?(this._$AH!==F&&this._$AR(),this._$AH=F):t!==this._$AH&&t!==L&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>T(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==F&&P(this._$AH)?this._$AA.nextSibling.data=t:this.T(S.createTextNode(t)),this._$AH=t}$(t){const{values:i,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=q.createElement(W(e.h,e.h[0]),this.options)),e);if(this._$AH?._$AD===o)this._$AH.p(i);else{const t=new Y(o,this),e=t.u(this.options);t.p(i),this.T(e),this._$AH=t}}_$AC(t){let i=K.get(t.strings);return void 0===i&&K.set(t.strings,i=new q(t)),i}k(t){T(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let e,o=0;for(const n of t)o===i.length?i.push(e=new Z(this.O(O()),this.O(O()),this,this.options)):e=i[o],e._$AI(n),o++;o<i.length&&(this._$AR(e&&e._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){void 0===this._$AM&&(this.v=t,this._$AP?.(t))}}class J{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,e,o,n){this.type=1,this._$AH=F,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=n,e.length>2||""!==e[0]||""!==e[1]?(this._$AH=Array(e.length-1).fill(new String),this.strings=e):this._$AH=F}_$AI(t,i=this,e,o){const n=this.strings;let s=!1;if(void 0===n)t=G(this,t,i,0),s=!P(t)||t!==this._$AH&&t!==L,s&&(this._$AH=t);else{const o=t;let r,c;for(t=n[0],r=0;r<n.length-1;r++)c=G(this,o[e+r],i,r),c===L&&(c=this._$AH[r]),s||=!P(c)||c!==this._$AH[r],c===F?t=F:t!==F&&(t+=(c??"")+n[r+1]),this._$AH[r]=c}s&&!o&&this.j(t)}j(t){t===F?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class X extends J{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===F?void 0:t}}class Q extends J{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==F)}}class tt extends J{constructor(t,i,e,o,n){super(t,i,e,o,n),this.type=5}_$AI(t,i=this){if((t=G(this,t,i,0)??F)===L)return;const e=this._$AH,o=t===F&&e!==F||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==F&&(e===F||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class it{constructor(t,i,e){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=e}get _$AU(){return this._$AM._$AU}_$AI(t){G(this,t)}}const et=w.litHtmlPolyfillSupport;et?.(q,Z),(w.litHtmlVersions??=[]).push("3.2.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
class ot extends ${constructor(){super(...arguments),this.renderOptions={host:this},this.o=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this.o=((t,i,e)=>{const o=e?.renderBefore??i;let n=o._$litPart$;if(void 0===n){const t=e?.renderBefore??null;o._$litPart$=n=new Z(i.insertBefore(O(),t),t,void 0,e??{})}return n._$AI(t),n})(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.o?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.o?.setConnected(!1)}render(){return L}}ot._$litElement$=!0,ot.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:ot});const nt=globalThis.litElementPolyfillSupport;nt?.({LitElement:ot}),(globalThis.litElementVersions??=[]).push("4.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const st=t=>(i,e)=>{void 0!==e?e.addInitializer((()=>{customElements.define(t,i)})):customElements.define(t,i)};var rt,ct;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(rt||(rt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ct||(ct={}));const at="my-harmony-card",lt="my-harmony-card-editor",ht=((t,...i)=>{const e=1===t.length?t[0]:i.reduce(((i,e,o)=>i+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(e)+t[o+1]),t[0]);return new s(e,t,o)})`
  @keyframes blinker {
    50% {
      opacity: 0;
    }
...
.btn-act:active {
  ...
  .popup-dialog img:hover {
    ...
    `}setDimensions(t){const i=Object.assign(Object.assign({},{scale:1,border_width:1}),t||{}),e=parseFloat(i.border_width);return I`
      <hr style="width: 100%; height: 1px; border: none; border-top: 1px solid #eeeeee;">
    ...
    `}importActivities(){return I`
      ...
      <hr style="width: 100%; height: 1px; border: none; border-top: 1px solid #eeeeee;">
    `}handleImportActivitiesCheckboxChange(t){const i=t.target;t.target.checked&&this.syncActivities(),setTimeout((()=>{i.checked=!1}),200)}checkActivities(){const t=this._config.activities||{};if("object"!=typeof t||null===t)return I`
        <div class="import-activities">
          <label for="checkActivitiesNo">"No activities configured, yet"</label>
        </div>
      `;const i=Object.keys(t);return i.length>0?I`
        <div class="heading" style="margin-bottom: -10px;">Activities:</div>
        <br>
        <div class="outer-container">
          ${i.map(((i,e)=>{let o=Object.assign({},t[i]);if(!o.device_id){o.device_id="-1";const t=Object.assign(Object.assign({},this._config.activities),{[i]:o});this._config=Object.assign(Object.assign({},this._config),{activities:t}),this.requestUpdate()}return I`
    ...
    `:I``}static get styles(){return ht}};dt=t([st(lt)],dt);console.info("%c  My Harmony Remote Control Card  \n%c  version: v@MY_HARMOY_CARD_VERSION_PLACEHOLDER@  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");const ut=window;ut.customCards=ut.customCards||[],ut.customCards.push({type:at,name:"My Harmony Remote Control Card",preview:!0,description:"Remote control card for Harmony Companion Remote Controllers"});let pt=class extends ot{static get styles(){return ht}static getConfigElement(){return document.createElement(lt)}static getStubConfig(t){let i=Object.keys(t.entities).filter((t=>t.startsWith("remote.")));const e=i.length>0?i[0]:"";return{type:`custom:${at}`,entity:e}}_getFavorites(){var t;const i=null===(t=this.config.activities)||void 0===t?void 0:t[this._current_activity];return((null==i?void 0:i.favorites)||[]).map((t=>({number:t.number,image:t.image})))}_handle123ButtonDown(t){"touchstart"===t.type&&t.touches.length>1||(t.preventDefault(),this.isButtonPressed=!0,this.buttonTimeout=setTimeout((()=>{this._popcard(),this.isButtonPressed=!1}),500))}_handle123ButtonUp(t){t.preventDefault(),this.isButtonPressed&&(this._show_keypad=!this._show_keypad),this.buttonTimeout&&(clearTimeout(this.buttonTimeout),this.buttonTimeout=null),this.isButtonPressed=!1}_handleButtonDown(t,i){this.isButtonPressed=!0,this.buttonTimeout=setTimeout((()=>{this.isButtonPressed&&("media"===i?this._moreMediaPlayer():this._button(i),this.isButtonPressed=!1)}),500)}_handleButtonUp(t){this.isButtonPressed&&this._button(t),this.buttonTimeout&&(clearTimeout(this.buttonTimeout),this.buttonTimeout=null),this.isButtonPressed=!1}static get properties(){return{hass:{},config:{},_show_keypad:{},_show_activity:{},_show_vol_text:{},_current_activity:{type:String}}}constructor(){super(),this.isButtonPressed=!1,this.buttonTimeout=null,this._show_keypad=!1,this._show_activity=!1,this._current_activity="",this.debug=!1,this._dialogOpen=!1}_toggleDialog(){this._dialogOpen=!this._dialogOpen,this.requestUpdate()}_popcard(){this._dialogOpen=!0,this.requestUpdate()}_moreMediaPlayer(){const t=this.config.activities[this._current_activity].player_name;t&&function(t,i,e,o){o=o||{},e=null==e?{}:e;var n=new Event(i,{bubbles:void 0===o.bubbles||o.bubbles,cancelable:Boolean(o.cancelable),composed:void 0===o.composed||o.composed});n.detail=e,t.dispatchEvent(n)}(this,"hass-more-info",{entityId:t}),this.debug&&console.log("More Info media_player called",t)}_renderTable(){const t=this._getFavorites(),i=this.config.favsize?this.config.favsize:50,e=this.config.faviconpath?this.config.faviconpath:"/local/community/my-harmony-card/stations/";return I`
        <!-- <tbody>  -->
          <!-- <div class="popup-container"> -->
            ...
            `))}
       <!-- </tbody>-->
    `}render(){var t;const i=this.hass.states[this.config.entity];this.config.color_buttons,this._current_activity=i.attributes.current_activity;const e=null===(t=this.config.activities)||void 0===t?void 0:t[this._current_activity];e?(this.defaultDeviceId=e.device_id||null,this.volumeDeviceId=e.volume_device_id||this.defaultDeviceId):(this.defaultDeviceId=-1,this.volumeDeviceId=-1,this._current_activity="PowerOff");const o="PowerOff"===this._current_activity?"red":"green";this.debug&&console.log(`Current Activity ${i.attributes.current_activity} - DeviceID: ${e.device_id} `);const n=this.config.dimensions&&this.config.dimensions.border_width?this.config.dimensions.border_width:"1px",s=this.config.dimensions&&this.config.dimensions.scale?this.config.dimensions.scale:1,r=Math.round(260*s)+"px",c=this.config.colors&&this.config.colors.background?this.config.colors.background:"var( --ha-card-background, var(--card-background-color, white) )",a=this.config.colors&&this.config.colors.border?this.config.colors.border:"var(--primary-text-color)",l=this.config.colors&&this.config.colors.buttons?this.config.colors.buttons:"var(--secondary-background-color)",h=this.config.colors&&this.config.colors.text?this.config.colors.text:"var(--primary-text-color)";return I`
        ...
        <div class="card">
            <div class="page"
                ...
                ${this.config.name?I` <div class="tv_title" style="color:${h}" >${this.config.name}</div> `:""}
                    ...
                    <button class="act_action button-style" style="color:${h}"
                    ...
                    <div class="grid-container-act">
                        ...
                        <div class="grid-item-act">
                           ${i.attributes.activity_list.map((t=>I`
                                <button class="button-style ${i.attributes.current_activity===t?"btn-act-on":"btn-act ripple overlay"}" @click=${()=>{this._select_activity(t),this._show_activity=!1}}>${t}</button>
                            `))}
                        </div>
                    </div>
                    ...
                    <div class="grid-container-cursor">
                      <div class="shape">
                       ...
                       <div class="grid-container-extra">
                          ${this.config.activities&&this._current_activity&&this.config.activities[this._current_activity]&&this.config.activities[this._current_activity].Button1?I`
                              <button class="ripple btn-extra button-style"
                                ...
                                ${this.config.activities[this._current_activity].Button1.icon?I`<ha-icon class="mdi-extra button-style" icon="${this.config.activities[this._current_activity].Button1.icon}"></ha-icon>`:this.config.activities[this._current_activity].Button1.name}
                              </button>`:""}

                          ${this.config.activities&&this._current_activity&&this.config.activities[this._current_activity]&&this.config.activities[this._current_activity].Button2?I`
                              <button class="ripple btn-extra button-style"
                                ...
                                ${this.config.activities[this._current_activity].Button2.icon?I`<ha-icon class="mdi-extra button-style" icon="${this.config.activities[this._current_activity].Button2.icon}"></ha-icon>`:this.config.activities[this._current_activity].Button2.name}
                              </button>`:""}

                          ${this.config.activities&&this._current_activity&&this.config.activities[this._current_activity]&&this.config.activities[this._current_activity].Button3?I`
                              <button class="ripple btn-extra button-style"
                                ...
                                ${this.config.activities[this._current_activity].Button3.icon?I`<ha-icon class="mdi-extra button-style" icon="${this.config.activities[this._current_activity].Button3.icon}"></ha-icon>`:this.config.activities[this._current_activity].Button3.name}
                              </button>`:""}

                          ${this.config.activities&&this._current_activity&&this.config.activities[this._current_activity]&&this.config.activities[this._current_activity].Button4?I`
                              <button class="ripple btn-extra button-style"
                                @click=${()=>this._button(this.config.activities[this._current_activity].Button2.command)}
                                title=${this.config.activities[this._current_activity].Button4.tooltip||""}>
                                ${this.config.activities[this._current_activity].Button4.icon?I`<ha-icon class="mdi-extra button-style" icon="${this.config.activities[this._current_activity].Button4.icon}"></ha-icon>`:this.config.activities[this._current_activity].Button4.name}
                              </button>`:""}
                       </div>
                       <!--  Extra buttons end -->
                       <!-- Extra BUTTONS #2  -->
